...
- **Weather** shows the current conditions, the next five hours and four days. It uses [Open-Meteo](https://open-meteo.com) (free, no account) for your Mac's location or a place you pick. Press the weather button again while it's up to list the next five hours (Today), once more for the next six days (This Week), and a third time to go back to the forecast.
...
<img src="docs/weather-today-polvo.png" width="49%" alt="Weather's Today view: the next five hours"> <img src="docs/weather-week-polvo.png" width="49%" alt="Weather's This Week view: the next six days">
